    ...
    <div class="container-fluid">
        <div class="card card-info card-outline mb-4">
            ...
            <div class="card-header">
                <div class="card-title">Create Catalogue Package</div>
            </div>
            <!--end::Header-->
            <!--begin::Form-->
            <form class="needs-validation" novalidate method="POST" action="{{ route('admin.catalogue.store') }}"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" id="description" rows="6"
                                ...
                                placeholder="Tulis deskripsi paket..." required>{{ old('description') }}</textarea>
                            <div class="valid-feedback">Looks good!</div>
                                ...
                                <div class="card-body p-3">
                                    <div class="preview-wrap position-relative">
                                        ...
                                        <img id="preview" alt="Preview"
                                            class="w-100 h-100 rounded object-fit-cover d-none">

                                        {{-- placeholder saat belum ada gambar --}}
                                        <div id="preview-placeholder"
                                            class="h-100 w-100 d-flex flex-column align-items-center justify-content-center text-center text-muted">
                                            <div class="mb-2">
                                        ...
                                        <div id="preview-actions" class="position-absolute top-0 end-0 m-2 d-none">
                                            <div class="btn-group">
                                    ...
                                    <small id="preview-meta" class="text-muted d-none"></small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <select id="status_publish" name="status_publish"
                                ...
                                <option value="" disabled {{ old('status_publish')===null ? 'selected':'' }}>Pilih
                                    status</option>
                                <option value="Y" {{ old('status_publish')==='Y' ? 'selected':'' }}>Ya (Publish)
                                </option>
                                <option value="N" {{ old('status_publish')==='N' ? 'selected':'' }}>Tidak (Draft)
                                </option>
                            </select>
